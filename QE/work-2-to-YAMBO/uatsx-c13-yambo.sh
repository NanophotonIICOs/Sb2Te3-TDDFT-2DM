...
CALC="pw.x"
TMP_DIR="tmp"
SYS0="Sb2Te3-uatsx-c13-yambo-0.0"
SYS1="Sb2Te3-uatsx-c13-yambo-1.0"
SYS2="Sb2Te3-uatsx-c13-yambo-2.0"
SYS3="Sb2Te3-uatsx-c13-yambo-3.0"
SYS4="Sb2Te3-uatsx-c13-yambo-4.0"
SYS5="Sb2Te3-uatsx-c13-yambo-5.0"
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_0 > $nscf_out_0
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_1 > $nscf_out_1
echo "$NSCF calculation is end "
echo " "
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_2 > $nscf_out_2
echo "$NSCF calculation is end "
echo " "
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_3 > $nscf_out_3
echo "$NSCF calculation is end "
echo " "
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_4 > $nscf_out_4
echo "$NSCF calculation is end "
echo " "
...
echo " "
mpirun -np $SLURM_NTASKS pw.x < $nscf_in_5 > $nscf_out_5
echo "$NSCF calculation is end "
echo " "
