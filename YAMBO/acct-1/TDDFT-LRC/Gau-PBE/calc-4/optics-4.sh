...
cd ./$calc0
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-0.0.save
...
cd ..
cd ./$calc1
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-1.0.save
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/yambo 
...
cd ..
cd ./$calc2
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-2.0.save
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/yambo 
...
cd ..
cd ./$calc3
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-3.0.save
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/yambo 
...
cd ..
cd ./$calc4
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-4.0.save
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/yambo 
...
cd ..
cd ./$calc5
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/p2y -I ../../../../../QE-work-2/gaup/calc-1/tmp/Sb2Te3-uatsx-c4-5.0.save
mpirun -np ${SLURM_NTASKS} $YAMBOGCCROOT/yambo 
