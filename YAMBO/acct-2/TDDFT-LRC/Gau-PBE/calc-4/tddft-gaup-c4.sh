#!/bin/bash
#SBATCH -J tddft-gaup-c4             # Job name             
...
cd ./$calc0
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-0.0.save
...
cd ..
cd ./$calc1
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-1.0.save
mpirun -np ${SLURM_NTASKS} yambo 
...
cd ..
cd ./$calc2
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-2.0.save
mpirun -np ${SLURM_NTASKS} yambo 
...
cd ..
cd ./$calc3
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-3.0.save
mpirun -np ${SLURM_NTASKS} yambo 
...
cd ..
cd ./$calc4
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-4.0.save
mpirun -np ${SLURM_NTASKS} yambo 
...
cd ..
cd ./$calc5
mpirun -np ${SLURM_NTASKS} p2y -I ../../../../../../QE/gaup/calc-2/Sb2Te3-uatsx-c4-5.0.save
mpirun -np ${SLURM_NTASKS} yambo 
